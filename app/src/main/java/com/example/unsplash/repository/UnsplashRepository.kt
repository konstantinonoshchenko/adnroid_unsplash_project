...
import com.example.unsplash.api.UnsplashResource
import com.example.unsplash.api.UnsplashResponseHandler
import com.example.unsplash.dao.*
import com.example.unsplash.data.*
import com.example.unsplash.data.collections.Collections
import com.example.unsplash.data.collections.CoverPhoto
...
import com.example.unsplash.data.download.Download
import com.example.unsplash.data.me.Me
import com.example.unsplash.data.me.ProfileImage
import com.example.unsplash.utils.Constants.ACCESS_KEY
import com.example.unsplash.utils.Constants.GEO
import com.example.unsplash.utils.Constants.SECRET
...
class UnsplashRepository @Inject constructor(
    ...
    fun getCollections(token: String) =
        Pager(
            ...
            pagingSourceFactory = { UnsplashPagingCollections(unsplashApi, token, collectionsDao,context) }
        ).liveData
                        ...
                        photo.add(
                            Results(
                                ...
                                user = User(
                                    ...
                                    name = it.name,
                                    profileImage = com.example.unsplash.data.ProfileImage(small = it.userProfileImageSmall),
                                    bio = it.bio,
                        ...
                        photo.add(
                            Results(
                                ...
                                user = User(
                                    name = it.name,
                                    username = it.userName,
                                    profileImage = com.example.unsplash.data.ProfileImage(
    ...
    suspend fun getMeCollections(username: String, token: String): List<Collections>? {
        val result = try {
            ...
            res.forEach {
                val collections = com.example.unsplash.data.database.MyCollections(
                    id = it.id!!,
                    title = it.title ?: "",
                ...
                res.forEach {
                    myCollections.add(
                        Collections(
                            ...
                            user = com.example.unsplash.data.collections.User(
                                username = it.userName,
                                name = it.name,
                                profileImage = com.example.unsplash.data.collections.ProfileImage(
                                    medium = it.profileImageMedium
                                )
                            ),
                            description = it.description,
                            coverPhoto = CoverPhoto(
                                urls = com.example.unsplash.data.collections.Urls(
                                    regular = it.urlsRegular,
                                    full = it.urlsFull
                                ),
            ...
            if (resList.isEmpty()) responseHandler.handleException(e)
                ...
                val photo = Results(
                    ...
                    user = User(
                        ...
                        username = res.userName,
                        bio = res.bio,
                        profileImage = com.example.unsplash.data.ProfileImage(small = res.userProfileImageSmall)
                    ),
                    location = Location(
