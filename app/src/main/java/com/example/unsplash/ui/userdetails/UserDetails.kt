...
import com.example.unsplash.Authorization
import com.example.unsplash.R
import com.example.unsplash.data.Results
import com.example.unsplash.data.collections.Collections
import com.example.unsplash.databinding.FragmentNotificationsBinding
import com.example.unsplash.utils.Constants.GEO
import com.example.unsplash.utils.Constants.GOOGLE_MAPS
...
import com.example.unsplash.utils.Constants.KEY_SKIP
...
import com.example.unsplash.utils.Constants.TAB_LIKES
import com.example.unsplash.utils.Constants.TAB_PHOTO
import com.example.unsplash.utils.LaunchSetWorkers
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.user.observe(viewLifecycleOwner) {
            ...
            if (token != null) {
                ...
                binding.apply {
                    tabFoto.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    collection.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    tabLikes.setTextAppearance(R.style.Theme_Unsplash_Text)
                }
            }
            binding.tabFoto.setOnClickListener { _ ->
                ...
                binding.apply {
                    ...
                    tabLikes.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    collection.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    tabFoto.setTextAppearance(R.style.Theme_Unsplash_Text)
                }
            ...
            binding.collection.setOnClickListener { _ ->
                ...
                binding.apply {
                    tabFoto.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    tabLikes.setTextAppearance(R.style.Theme_Unsplash_Text_Grey)
                    collection.setTextAppearance(R.style.Theme_Unsplash_Text)
                }
            }
        }
