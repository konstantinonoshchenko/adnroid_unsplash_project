...
import com.example.unsplash.databinding.ItemUnsplashCollectionBinding
    ...
    inner class CollectionViewHolder(val binding: ItemUnsplashCollectionBinding) :
        ...
        fun bind(collection: Collections,context: Context) {
            binding.apply {
                ...
                countPhotoInCollections.text = "${collection.totalPhotos.toString()} ${context.getString(R.string.photograf)}"
